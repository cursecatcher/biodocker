...
public:
	...
	inline unsigned int getFreq(){ return freqK; };
	...
	//!It initializes the k-mers size for all the instances   
	static void setKmer(const unsigned int ksize) {mybitset::ksize=ksize;};
	
	//!It returns the k-mers size for all the instances   
	static int getKmer(void) {return ksize;};
